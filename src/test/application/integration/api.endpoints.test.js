...
// Pruebas de integración para los endpoints de la API: En esta sección, se definen las pruebas de integración utilizando Jest y Supertest para verificar el correcto funcionamiento de los endpoints de la API, asegurando que las rutas respondan con los códigos de estado esperados y que la lógica de negocio se ejecute correctamente al interactuar con los controladores y servicios, incluyendo la autenticación con JWT para los endpoints protegidos.
